...
import dev.lcy0x1.json.JsonClass.JCGetter;
import dev.lcy0x1.json.JsonException.Type;
import dev.lcy0x1.json.JsonField.GenType;
import dev.lcy0x1.json.JsonField.Handler;
...
public class JsonDecoder {
	...
	public static <T> T decode(JsonElement elem, Class<T> cls) {
		return (T) ExceptionHandler.get(() -> decode(elem, cls, null));
	}
